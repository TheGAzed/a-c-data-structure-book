...
\begin{lstlisting}[language=C, style=CodeEditor, label=lst:create-queue, title=source/sequence/iqueue.h]
...
\begin{lstlisting}[language=C, style=CodeEditor, label=lst:make-infinite-queue, title=source/sequence/iqueue.h]
...
\subsection{Apply on all elements}
