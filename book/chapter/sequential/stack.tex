...
\begin{lstlisting}[language=C, style=CodeEditor, label=lst:create-stack, title=source/sequence/istack.h]
...
\begin{lstlisting}[language=C, style=CodeEditor, label=lst:make-finite-stack, title=source/sequence/istack.h]
