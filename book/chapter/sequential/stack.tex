...
Combine the best of humbleness with pride and you get this. It's just a linked list, see \autoref{fig:list-array}, but the node is actually made up of an array of elements instead of just a singleton. A mathematical person may say that the previous implementations are but a simple subset of this superset of a stack structure, but i digress. 
