...
\part{Restricted sequential data structures} \label{pt:one}
...
I want to put list implementations into a separate book part, thus I hereby coin the term {\normalfont\texttt{Restricted sequential data structures}} as a subcategory of dynamic linear data structures.
