...
The \cite{geeksforgeeks_queue} article again simply explains what queue's are. 
C++'s \cite{cppreference_queue} shows how queues are also just deques in a sheep's clothing.
