...
\titleclass{\part}{top} % Nastaví 'part' ako bežnú sekciu
...
%\posttitle{\par\Large BOOK I\endtitlepage}
...
\mainmatter%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{chapter/cerpec}

\include{part/one}
\include{chapter/sequential/stack}
\include{chapter/sequential/queue}
\include{chapter/sequential/deque}
